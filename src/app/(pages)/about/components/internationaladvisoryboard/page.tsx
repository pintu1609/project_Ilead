...
const Internationaladvisoryboard: React.FC = () => {
  const { data, loading, error } = useBlogsByType('internationaladvisoryboard');
  ...
  return (
    <div className="sm:p-10 p-2 bg-[#f5f5f5]">
      ...
      <h2 className="text-4xl font-bold text-[#040677] text-center"> International Advisory Board</h2>
...
export default Internationaladvisoryboard;
