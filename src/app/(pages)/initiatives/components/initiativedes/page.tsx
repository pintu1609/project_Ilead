...
interface InitiativesdesProps {
}
const Initiativesdes: React.FC<InitiativesdesProps> = () => {
...
<div className="sm:p-10 p-2">
      ...
      <p className="mt-4 text-lg">
        This program prioritizes knowledge-sharing through articles, research papers, and media documentation. Its evidence-based approach ensures that the insights gathered influence policies and contribute to societal advancement. The initiative’s global outreach connects world leaders, academics, and activists, creating a platform for cross-cultural learning and international cooperation.
      </p>
      ...
      <p className="mt-4 text-lg">
        Through ILead Women, we aim to create a gender-inclusive future by empowering women to challenge traditional norms and lead change in their communities.
      </p>
      ...
      <p className="mt-4 text-lg">
        Rising Leaders recognizes that talent and potential exist across all socio-economic segments. By creating equal opportunities, the program ensures that young individuals can realize their full potential and contribute meaningfully to society.
      </p>
