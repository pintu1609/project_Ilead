...
const Partners: React.FC = () => {
  const { data, loading, error } = useBlogsByType('partners');
  console.log("🚀 ~ data:", data);

  return (
    <div className="sm:p-10 p-2 bg-[#f5f5f5] min-h-screen">
      <Head>
      ...
      <h2 className="text-4xl font-bold text-[#040677] text-center">Partners</h2>
      <p className="mt-6 text-lg text-[#848484] text-center">
